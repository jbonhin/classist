  ...
  <main>
    <div class="container py-4 text-center">
      ...
      <div class="row g-4">
        ...
        <!--div class="col-auto">
          <a href="./AddActuated.html" class="btn-cadastrar btn btn-primary btn-sm">Cadastrar</a>
        </div-->
      </div>
        ...
        <div class="col">
          <table class="table table-sm table-bordered table-striped">
            <thead>
              ...
              <th class="sort asc">Alarme</th>
              <th class="sort asc">Equipamento</th>
              <th class="sort asc">Situação</th>
              <th class="sort asc">Data de Entrada</th>
              <th class="sort asc">Data de Saída</th>
            ...
            <!-- TEMPLATE INCLUDE -->
            <?php //include_once("./includeList.php") ?>
